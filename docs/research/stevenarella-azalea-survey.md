...
`"1.8.9" => 47` (line 58) and dispatches
...
- Packet dispatch for 1.8 in the client: `src/server/mod.rs:610` (`ChunkData_NoEntities_u16 => on_chunk_data_no_entities_u16`),
...
- The per-state enums and the id→parser dispatch are generated by `declare_state_packets!`
